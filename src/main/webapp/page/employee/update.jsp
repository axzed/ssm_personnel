...
<html>
  ...
  <body>
    <div class="x-body">
        <form class="layui-form" method="POST" id="empForm"  action="${ctx}/employee/modify">
            ...
            <div class="layui-form-item" >
                ...
                <div class="layui-input-inline">
                    <input type="text" id="cardId" name="cardId" required="" lay-verify="required"
                           autocomplete="off" class="layui-input" value="${emp.cardId }">
                </div>
            </div>
                ...
                <div class="layui-input-inline">
                    <select id="jobId" name="jobId" class="valid" >
                        <c:forEach items="${requestScope.jobInfos}" var="job" varStatus="status">
                            <option value="${job.id}"<c:if test="${emp.jobId == job.id}">selected</c:if>>${job.name}</option>
                        </c:forEach>
                    </select>
                </div>
            </div>
                ...
                <div class="layui-input-inline">
                    <select id="deptId" name="deptId" class="valid">
                        <c:forEach items="${requestScope.deptInfos}" var="dept" varStatus="status">
                            <option value="${dept.id}"<c:if test="${emp.deptId == dept.id}">selected</c:if>>${dept.name}</option>
                        </c:forEach>
                    </select>
                </div>
            </div>
